...
const ProductControls = ({product}) => {
    ...
    return (
        <div className="w-full mx-auto">
            <button className="py-4 px-8 text-white font-bold text-xs rounded hover:text-gray-950 sameasbg-color text-white w-full" onClick={_handleAddCart}>Add to Cart</button>
