...
const ProductFilter = ({ products, onApplyFilters }) => {
    ...
    return (
        <aside id="default-sidebar" className="mt-16 fixed px-4 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 top-[23%] z-4" aria-label="Sidebar">
